    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="block w-full pl-9 pr-10 py-1.5 border border-gray-300 bg-white text-gray-900 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors placeholder-gray-500 text-base sm:text-sm"
