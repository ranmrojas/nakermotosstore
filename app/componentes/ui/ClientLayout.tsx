...
import PreloadOptimizer from "./PreloadOptimizer";
      ...
      <CartProvider>
        <ClientSessionProvider>
          ...
          <a
            ...
            className="fixed bottom-2 right-2 z-40 flex items-center justify-center bg-green-500 text-white rounded-full p-3 shadow-lg hover:bg-green-600 transition-all duration-200 hover:scale-110"
...
function HeaderWrapper() {
  ...
  useEffect(() => {
    ...
    if (pathname === "/productos") {
      // Verificar inmediatamente si la función está disponible
      if (typeof window.__toggleSidebar === "function") {
        setToggleSidebar(() => window.__toggleSidebar);
        return;
      }

      // Si no está disponible, esperar con un timeout más largo
