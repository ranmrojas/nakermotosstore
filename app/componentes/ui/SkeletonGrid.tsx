  ...
  return (
    <div className={`${gridClasses} ${className}`}>
      {Array.from({ length: count }).map((_, index) => (
        <div
          key={index}
          className="bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col items-center p-1 sm:p-2 h-full min-h-[180px]"
        >
          <div className="flex flex-col items-center w-full h-full">
            {/* Skeleton para la imagen */}
            <div className="relative w-full aspect-square bg-gray-200 rounded-t-lg mb-2 overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 animate-pulse"></div>
              {/* Simular algunos detalles de la imagen */}
              <div className="absolute top-1 left-1 w-8 h-4 bg-gray-300 rounded animate-pulse"></div>
            ...
            <div className="flex-1 w-full flex flex-col justify-between items-center p-2 pb-1">
              ...
              <div className="w-full mb-1">
                <div className="h-2 bg-gray-100 rounded w-2/3 animate-pulse"></div>
              </div>
              ...
              <div className="flex items-center justify-between w-full mt-auto mb-0">
                ...
                {/* Skeleton para botón */}
                <div className="ml-2 w-8 h-8 bg-gray-200 rounded-full animate-pulse"></div>
              </div>
              
              {/* Skeleton para SKU */}
              <div className="w-full text-right mt-1">
                <div className="h-2 bg-gray-100 rounded w-12 ml-auto animate-pulse"></div>
              </div>
            </div>
          </div>
        </div>
